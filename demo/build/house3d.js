...
(function (House3D) {
    ...
    (function (Models) {
        var Builds;
        (function (Builds) {
            var InWall = (function (_super) {
                __extends(InWall, _super);
                function InWall() {
                    var _this = _super.call(this) || this;
                    _this.type = "InWall";
                    _this._selectable = false;
                ...
                InWall.prototype.clone = function (recursive) {
                    var newObject = new InWall();
                    newObject.copy(this, recursive);
                    return newObject;
                };
                return InWall;
            }(Builds.Build));
            Builds.InWall = InWall;
        })(Builds = Models.Builds || (Models.Builds = {}));
    })(Models = House3D.Models || (House3D.Models = {}));
})(House3D || (House3D = {}));
var House3D;
    ...
    (function (Controls) {
        var GizmoMaterial = (function (_super) {
            ...
            function GizmoMaterial(parameters, highlight) {
                ...
                _this.blending =  THREE.NormalBlending;
                if (highlight)
        ...
        var LShape = (function (_super) {
            ...
            function LShape() {
                ...
                var material = new GizmoMaterial({ color: 0x0088ff }, 0x0088dd);
        ...
        var DShape = (function (_super) {
            ...
            function DShape(h) {
                var _this = this;
                var width = Width, height = h - 2*(-Width + Height);
                var geometry = new THREE.PlaneBufferGeometry(width, height);
                geometry.rotateY(Math.PI / 2);
                geometry.rotateZ(Math.PI / 2);
                var material = new GizmoMaterial({color: 0x51C6fa }, 0x51C6fa);
                _this = _super.call(this, geometry, material) || this;
                return _this;
            }
            return DShape;
        ...
        var TransformGizmo = (function (_super) {
            ...
            function TransformGizmo() {
                ...
                // var materialC = new THREE.SpriteMaterial( {  color: 0xff0000,depthWrite:false } );
                // _this.sprite  = new THREE.Sprite( materialC );
                // _this.sprite.scale.set( 50, 50, 1 );
            ...
            TransformGizmo.prototype.rotateGeometry = function (box) {
                ...
                this.handleGizmos.RY =
                    [
                        ...
                        [new DShape(z*2), [-x - dis, diff3, 0], [0, Math.PI / 2, 0]],
                        [new DShape(z*2), [x + dis, diff3, 0], [0, Math.PI / 2, 0]],

                        [new DShape(x*2), [0, diff3, z + dis], [0, -Math.PI, 0]],
                        [new DShape(x*2), [0, diff3, -z - dis], [0, 0, 0]]
                    ];
            };
